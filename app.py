...
def update_graph_live(n):
    ...
    result = result.rename(columns={"id_str": "Num of '{}' mentions".format(setting.TRACK_WORDS[0]), "created_at":"Time"})  
    ...
    neu_num = result[result['Time']>min10]["Num of '{}' mentions".format(setting.TRACK_WORDS[0])][result['polarity']==0].sum()
    neg_num = result[result['Time']>min10]["Num of '{}' mentions".format(setting.TRACK_WORDS[0])][result['polarity']==-1].sum()
    pos_num = result[result['Time']>min10]["Num of '{}' mentions".format(setting.TRACK_WORDS[0])][result['polarity']==1].sum()
    ...
    daily_tweets_num = back_up['daily_tweets_num'].iloc[0] + result[-6:-3]["Num of '{}' mentions".format(setting.TRACK_WORDS[0])].sum()
                        ...
                        dcc.Graph(
                            ...
                            figure={
                                'data': [
                                    go.Scatter(
                                        x=time_series,
                                        y=result["Num of '{}' mentions".format(setting.TRACK_WORDS[0])][result['polarity']==0].reset_index(drop=True),
                                        name="Neutrals",
                                        opacity=0.8,
                                        mode='lines',
                                    ...
                                    go.Scatter(
                                        x=time_series,
                                        y=result["Num of '{}' mentions".format(setting.TRACK_WORDS[0])][result['polarity']==-1].reset_index(drop=True).apply(lambda x: -x),
                                        name="Negatives",
                                        opacity=0.8,
                                        mode='lines',
                                    ...
                                    go.Scatter(
                                        x=time_series,
                                        y=result["Num of '{}' mentions".format(setting.TRACK_WORDS[0])][result['polarity']==1].reset_index(drop=True),
                                        name="Positives",
                                        opacity=0.8,
                                        mode='lines',
